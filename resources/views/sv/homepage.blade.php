...
<html lang="en">
  <head>
    ...
    <title>Hunre sinh viên</title>

  </head>
  <body>
    @extends('gv.layout.layout')
        @section('page')
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0"> Hello! <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block"></span>
              </h3>
              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="https://scontent.fhan18-1.fna.fbcdn.net/v/t39.30808-1/333141592_3275806515899074_7162450609244792146_n.jpg?stp=dst-jpg_p240x240&_nc_cat=107&ccb=1-7&_nc_sid=fe8171&_nc_ohc=mV15bDCDce8AX-v7nNj&_nc_ht=scontent.fhan18-1.fna&oh=00_AfDJpFyACzJP-HVj8a94HgoA5srcoJwdf83SK2GZ4T2kQg&oe=65026B75" alt="image" />
                        ...
                        <p class="text-muted">
                          ...
                          <span class="d-inline-block">
                            <span class="d-flex d-inline-block">
                              <img class="ml-1" src="https://scontent.fhan18-1.fna.fbcdn.net/v/t39.30808-1/333141592_3275806515899074_7162450609244792146_n.jpg?stp=dst-jpg_p240x240&_nc_cat=107&ccb=1-7&_nc_sid=fe8171&_nc_ohc=mV15bDCDce8AX-v7nNj&_nc_ht=scontent.fhan18-1.fna&oh=00_AfDJpFyACzJP-HVj8a94HgoA5srcoJwdf83SK2GZ4T2kQg&oe=65026B75" alt="" />
